    ...
    return (
        <div className="bg-white p-4 sm:p-6 rounded-lg border border-zinc-200 mt-8">
            <div className="flex justify-between items-center mb-4">
                ...
                <a href="#" className="text-sm font-medium text-green-600 hover:text-green-700">See all</a>
            </div>
                            ...
                            items.map((order, index) => (
                                <tr key={order.id} className="bg-white border-b border-zinc-200 hover:bg-zinc-50">
                                    ...
                                    <td className="px-6 py-4">
                                        <span className="bg-yellow-100 text-yellow-800 text-xs font-medium px-2.5 py-1 rounded-full">{order.status}</span>
                                    </td>
                                </tr>
                            ))
                        )}
