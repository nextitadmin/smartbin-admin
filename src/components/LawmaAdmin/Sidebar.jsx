...
const navItems = [
  ...
  { name: 'KYC', href: '/kyc', icon: VerifyIcon },
  { name: 'User Management', href: '/user-management', icon: UserIcon },
  { name: 'PSPs', href: '/psp-management', icon: PSPIcon },
  { name: 'Smartbin Management', href: '/smartbin-management', icon: BinIcon },
  { name: 'Waste Management', href: '/waste-management', icon: WasteIcon },
  { name: 'Revenue', href: '/revenue', icon: DocumentIcon },
          ...
          <nav className="flex-1 px-4 py-6 space-y-2">
            {navItems.map((item) => {
              ...
              const isActive = item.href === '/user-management' 
                ...
                : item.href === '/psp-management'
                  ? location.pathname === item.href || location.pathname.startsWith('/psp-companies')
                  : item.href === '/revenue'
                    ? location.pathname === item.href || location.pathname === '/all-payments'
