...
const OrderDetailsContent = ({ order, onClose }) => {
        ...
        <div className="bg-white p-4 sm:p-6 rounded-lg border border-zinc-200 w-full max-w-4xl mx-auto flex flex-col max-h-[90vh]">
            ...
            <div className="overflow-y-auto flex-grow">
                ...
                <div className="flex items-center gap-2 py-4 border-b border-zinc-200">
                    <CalendarDaysIcon />
                    {/* Display activation date if available, otherwise order/delivery date */}
                    <p className="text-sm text-zinc-800 font-medium">{formatDate(order.activation?.activationDate || order.orderDate)}</p>
                </div>
                ...
                <div className="py-6">
                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        <div className="flex flex-col sm:flex-row gap-6">
                            ...
                            <div className="flex-1"><DetailItem label="Activated" value={formatDate(order.activation?.activationDate)} /></div>
                        </div>
                    </div>
                </div>
            </div>
...
// --- MODAL WRAPPER ---
const ActivatedOrderModal = ({ isOpen, order, onClose }) => {
    ...
    return (
        ...
        >
            {!order ? (
                ...
                <OrderDetailsContent order={order} onClose={onClose} />
            )}
        </div>
    );
};

export default ActivatedOrderModal;
