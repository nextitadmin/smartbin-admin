...
export default function Auth() {
  ...
  const handleSubmit = async (e) => {
    ...
    const loginEndpoints = {
      SuperAdmin: "/lawma/auth/login",
      LawmaAdmin: "/lawma/auth/login",
      Partners: "/lawma-partner/auth/login",
      TeamMembers: "/lawma-partner/auth/login",
      PSPs: "/psps/auth/login",
      PSPsTeamMembers: "/psps/auth/login"
  ...
  return (
    <div className="flex min-h-screen flex-col md:flex-row bg-white">
      {/* Left Panel */}
      <div className="lg:w-7/12 w-full h-full flex flex-col  lg:px-36 px-8 py-8 bg-white">
