                    ...
                    <tbody className="bg-white divide-y divide-zinc-200">
                        {currentTableData.map((order, index) => (
                            <tr key={order.id}>
                                ...
                                <td className="px-6 py-4 whitespace-nowrap text-sm text-zinc-500">{order.orderDate.toLocaleString('en-US', { month: '2-digit', day: '2-digit', year: 'numeric', hour: 'numeric', minute: 'numeric', hour12: true })}</td>
