                    ...
                    <main className="p-4 md:px-4">
                        ...
                        ${activeTab === 'roles-and-privileges'
                                            ...
                                            <thead>
                                                {activeTab === 'members' ? (
                                                    <tr>
                                                        ...
                                                        <th className="px-4 py-3 text-left text-sm font-medium uppercase tracking-wider text-zinc-700 cursor-pointer" onClick={() => handleSort('phone')}>
                                                            <div className="flex items-center">
                                                                Phone number
                                                                <SortIcon direction={sortConfig.key === 'phone' ? sortConfig.direction : null} />
                                                            </div>
                                                        </th>
                                                        <th className="px-4 py-3 text-left text-sm font-medium uppercase tracking-wider text-zinc-700 cursor-pointer" onClick={() => handleSort('role')}>
                                                            <div className="flex items-center">
                                                                Role
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th className="px-4 py-3 text-left text-sm font-medium uppercase tracking-wider text-zinc-700 cursor-pointer" onClick={() => handleSort('permission')}>
                                                            <div className="flex items-center">
                                                                Permission
                                                                <SortIcon direction={sortConfig.key === 'permission' ? sortConfig.direction : null} />
                                                            </div>
                                                        </th>
                                                        <th className="px-4 py-3 text-left text-sm font-medium uppercase tracking-wider text-zinc-700 cursor-pointer" onClick={() => handleSort('members')}>
                                                            <div className="flex items-center">
                                                                Members
                                                                <SortIcon direction={sortConfig.key === 'members' ? sortConfig.direction : null} />
                                                            </div>
                                                        </th>
                                                        <th className="px-4 py-3 text-left text-sm font-medium uppercase tracking-wider text-zinc-700 cursor-pointer" onClick={() => handleSort('dateCreated')}>
                                                            <div className="flex items-center">
                                                                Date created
                                            ...
                                            <tbody>
                                                {activeTab === 'members' ? (
                                                    ...
                                                    currentPageItems.map((role, index) => (
                                                        <tr key={role.id} className="border-b border-zinc-100 hover:bg-zinc-50 transition-colors">
                                                            <td className="px-4 py-3 text-sm text-zinc-900 whitespace-nowrap">{startIndex + index + 1}.</td>
                                                            <td className="px-4 py-3 text-sm text-zinc-900 whitespace-nowrap">{role.role}</td>
                                                            <td className="px-4 py-3 text-sm text-zinc-700 whitespace-nowrap">{role.permission}</td>
                                                            <td className="px-4 py-3 text-sm text-zinc-700 whitespace-nowrap">{role.members}</td>
                                                            <td className="px-4 py-3 text-sm text-zinc-700 whitespace-nowrap">{role.dateCreated}</td>
                                                            <td className="px-4 py-3 whitespace-nowrap">
                                                                <div className="relative">
                                                                    <button
                            ...
                            {isModalOpen && activeTab === 'deactivate' && (() => {
                                ...
                                const currentMember = actionType === 'member' 
                                    ? teamMembers.find(member => member.id === currentMemberId || member._id === currentMemberId)
                                    : null;
                                    ...
                                    <div className="fixed inset-0 bg-black/30 flex items-center justify-center p-4 z-40 transition-opacity duration-300 ease-in-out">
                                        <div className="bg-white rounded-2xl shadow-xl px-8 py-12 w-full max-w-xl max-h-[90vh] overflow-y-auto">
                                            <div className="flex flex-col justify-center items-center gap-4">
                                                {/* icon */}
                                                <span className='mt-7'>
                                                    {actionType === 'member' && isActivating ? (
                                                        <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            ...
                                                            <path d="M24 14V24M24 24L19 19M24 24L29 19" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                                        </svg>
                                                    ) : (
                                                ...
                                                <h3 className={`text-2xl font-semibold ${isActivating ? 'text-green-700' : 'text-red-700'}`}>
                                                    {actionType === 'member' ? `${actionTextCap} User?` : 'Remove Role?'}
                                                </h3>
                                                ...
                                                {(currentMemberId || currentRoleId) && (
                                                    <div className="mb-6">
                                                        <p className="text-zinc-700 text-lg">
                                                            Are you sure you want to {actionType === 'member' ? actionText : 'remove'}{' '}
                                                ...
                                                <div className="flex justify-end gap-4 mt-2">
                                                    ...
                                                    >
                                                        {(isDeactivating || isRemovingRole) ? (
                                                            <>
                                                                <LoadingSpinnerIcon className="h-5 w-5 mr-2" />
                                                                {actionType === 'member' ? (isActivating ? 'Activating...' : 'Deactivating...') : 'Removing...'}
                                                            </>
                                                        ) : (
                                                            actionType === 'member' ? actionTextCap : 'Remove'
                                                        )}
                                                    </button>
                                                </div>
                                            </div>
